...
export function PostSkeleton({ showMedia = true }) {
    return (
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700 p-4 mb-4 animate-pulse">
            <div className="flex items-start gap-3 mb-4">
                ...
                <div className="w-6 h-6 rounded bg-gray-100 dark:bg-slate-700/50" />
            </div>
            ...
            {showMedia && (
                <div className="w-full aspect-video sm:h-80 bg-gray-200 dark:bg-slate-700 rounded-xl mb-4" />
            )}
