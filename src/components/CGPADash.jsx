            ...
            ${isPlaying ? 'max-w-5xl justify-center' : 'max-w-6xl items-stretch'}`}>
                ...
                ${isPlaying ? 'min-h-[500px]' : 'min-h-[460px] flex-1'}`}>
                    ...
                    <div className="relative w-full flex-1 flex flex-col items-center justify-center overflow-hidden bg-[#1e293b]" ref={containerRef}>
                        ...
                        {/* START SCREEN - Fixed layout to prevent emoji clipping */}
                        {gameState === 'START' && (
                            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-slate-900/90 backdrop-blur-sm p-4 overflow-y-auto">
                                <div className="bg-slate-800 border border-slate-600 p-6 sm:p-8 rounded-3xl shadow-2xl w-full max-w-[90%] sm:max-w-md text-center flex flex-col items-center justify-center gap-4 my-auto">
                                    ...
                                    <p className="text-[11px] text-slate-400 sm:hidden flex items-center justify-center gap-1.5 opacity-80 font-semibold mt-1">
                        ...
                        {gameState === 'GAMEOVER' && (
                            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-slate-900/95 backdrop-blur-md p-4 overflow-y-auto">
                                <div className="bg-slate-800 border border-slate-600 p-6 sm:p-8 rounded-3xl shadow-2xl w-full max-w-[90%] sm:max-w-sm text-center flex flex-col items-center justify-center gap-4 my-auto">

                                    <div className="text-4xl sm:text-5xl leading-none drop-shadow-md">💀</div>

                                    <h2 className="text-xl sm:text-2xl font-black text-rose-400 tracking-tight uppercase leading-tight">{gameOverTitle}</h2>

                                    <div className="bg-slate-900/80 w-full rounded-2xl p-4 border border-slate-700 shadow-inner flex flex-col justify-center items-center gap-1">
                                        <p className="text-slate-400 text-xs sm:text-sm font-bold uppercase tracking-widest">Final CGPA</p>
                                        <p className="text-5xl font-black text-blue-400 drop-shadow-md leading-none py-2">
                                            {(finalScore / 100).toFixed(2)}
                                        </p>
                                    </div>

                                    <form onSubmit={submitScore} className="flex flex-col gap-3 w-full">
                                        <input
