...
const MEME_TEMPLATES = [
    { id: '10-guy', name: '10 Guy / Stoner Stanley' },
    { id: 'afraid', name: 'Afraid to Ask Andy' },
    { id: 'alien', name: 'Ancient Aliens Guy' },
    { id: 'am-i-the-only-one', name: 'Am I The Only One Around Here' },
    { id: 'and-everybody-loses-their-minds', name: 'And Everybody Loses Their Minds' },
    { id: 'archer', name: 'Do You Want Ants? Because That\'s How You Get Ants' },
    { id: 'awkward-awesome', name: 'Awkward Awesome Penguin' },
    { id: 'awkward', name: 'Awkward Penguin' },
    { id: 'bad-joke-eel', name: 'Bad Joke Eel' },
    { id: 'bad-luck-brian', name: 'Bad Luck Brian' },
    { id: 'batman', name: 'Batman Slapping Robin' },
    { id: 'bern', name: 'Bernie I Am Once Again Asking' },
    { id: 'boardroom', name: 'Boardroom Meeting Suggestion' },
    { id: 'boat', name: 'I Should Buy A Boat Cat' },
    { id: 'both', name: 'Why Not Both?' },
    { id: 'brace', name: 'Brace Yourselves (Winter is Coming)' },
    { id: 'buzz', name: 'X, X Everywhere (Buzz Lightyear)' },
    { id: 'captain-obvious', name: 'Captain Obvious' },
    { id: 'captain', name: 'Look At Me, I\'m The Captain Now' },
    { id: 'change', name: 'Change My Mind' },
    { id: 'cheems', name: 'Cheems Doge' },
    { id: 'chuck', name: 'Chuck Norris' },
    { id: 'confession-bear', name: 'Confession Bear' },
    { id: 'conspiracy', name: 'Conspiracy Keanu' },
    { id: 'crying-floor', name: 'Crying on Floor' },
    { id: 'disastergirl', name: 'Disaster Girl' },
    { id: 'doge', name: 'Doge' },
    { id: 'drake', name: 'Drake Hotline Bling' },
    { id: 'dr-evil', name: 'Dr. Evil Air Quotes' },
    { id: 'elf', name: 'Buddy The Elf' },
    { id: 'epic', name: 'Epic Handshake' },
    { id: 'ermg', name: 'Ermahgerd' },
    { id: 'facepalm', name: 'Picard Facepalm' },
    { id: 'fine', name: 'This is Fine Dog' },
    { id: 'first-world', name: 'First World Problems' },
    { id: 'fry', name: 'Futurama Fry / Not Sure If' },
    { id: 'fwp', name: 'First World Problems' },
    { id: 'gandalf', name: 'Confused Gandalf' },
    { id: 'ggg', name: 'Good Guy Greg' },
    { id: 'grumpy', name: 'Grumpy Cat' },
    { id: 'harold', name: 'Hide the Pain Harold' },
    { id: 'hide', name: 'Hide the Pain Harold' },
    { id: 'hipster', name: 'Hipster Barista' },
    { id: 'im-the-captain-now', name: 'I\'m the Captain Now' },
    { id: 'inigo', name: 'Inigo Montoya' },
    { id: 'interesting', name: 'The Most Interesting Man in the World' },
    { id: 'is-this-a-pigeon', name: 'Is This A Pigeon?' },
    { id: 'jackie', name: 'Jackie Chan WTF' },
    { id: 'joker', name: 'Joker Mind Loss' },
    { id: 'kermit', name: 'But That\'s None Of My Business (Kermit)' },
    { id: 'leo', name: 'Leo Strutting' },
    { id: 'll', name: 'Laughing Lizard' },
    { id: 'matrix', name: 'Matrix Morpheus (What if I told you)' },
    { id: 'mocking', name: 'Mocking Spongebob' },
    { id: 'money', name: 'Shut Up And Take My Money' },
    { id: 'mordor', name: 'One Does Not Simply Walk Into Mordor' },
    { id: 'morpheus', name: 'Matrix Morpheus' },
    { id: 'mw', name: 'Mind Blown' },
    { id: 'nice', name: 'So I Got That Goin\' For Me, Which is Nice' },
    { id: 'no-idea', name: 'I Have No Idea What I\'m Doing Dog' },
    { id: 'ntot', name: 'Not Sure If...' },
    { id: 'one-does-not-simply', name: 'One Does Not Simply' },
    { id: 'oprah', name: 'Oprah You Get A' },
    { id: 'panik-kalm-panik', name: 'Panik Kalm Panik' },
    { id: 'patrick', name: 'Patrick Star' },
    { id: 'philosoraptor', name: 'Philosoraptor' },
    { id: 'pigeon', name: 'Is This a Pigeon?' },
    { id: 'pooh', name: 'Tuxedo Pooh / Classy Pooh' },
    { id: 'ptj', name: 'Pacha / When The Sun Hits That Ridge Just Right' },
    { id: 'raptor', name: 'Philosoraptor' },
    { id: 'red-dress', name: 'Distracted Boyfriend / Red Dress' },
    { id: 'rollsafe', name: 'Roll Safe Think About It' },
    { id: 'sad-cat', name: 'Sad Cat' },
    { id: 'sad-frog', name: 'Sad Frog / Pepe' },
    { id: 'saltb', name: 'Salt Bae' },
    { id: 'sarcastic-bear', name: 'Sarcastic Bear' },
    { id: 'scumbag', name: 'Scumbag Steve' },
    { id: 'seagull', name: 'Inhaling Seagull' },
    { id: 'sips-tea', name: 'Kermit Sips Tea' },
    { id: 'skeptical', name: 'Third World Skeptical Kid' },
    { id: 'smug', name: 'Smug Frog' },
    { id: 'spiderman', name: 'Spiderman Pointing' },
    { id: 'spongebob', name: 'Mocking Spongebob' },
    { id: 'squidward', name: 'Savage Patrick / Squidward' },
    { id: 'success', name: 'Success Kid' },
    { id: 'tenguy', name: '10 Guy' },
    { id: 'third-world-success', name: 'Third World Success' },
    { id: 'this-is-fine', name: 'This is Fine' },
    { id: 'too-damn-high', name: 'The Rent Is Too Damn High' },
    { id: 'toy', name: 'Toy Story Everywhere' },
    { id: 'trade', name: 'Trade Offer' },
    { id: 'trump', name: 'Donald Trump' },
    { id: 'uganda', name: 'Ugandan Knuckles' },
    { id: 'uno', name: 'Draw 25 or...' },
    { id: 'waiting', name: 'Waiting Skeleton' },
    { id: 'winter', name: 'Winter is Coming' },
    { id: 'woman-yelling-cat', name: 'Woman Yelling At Cat' },
    { id: 'wonka', name: 'Condescending Wonka' },
    { id: 'wtf', name: 'WTF Picard' },
    { id: 'yall-got-any-more-of-that', name: 'Y\'all Got Any More Of That' },
    { id: 'y-u-no', name: 'Y U NO' }
];
