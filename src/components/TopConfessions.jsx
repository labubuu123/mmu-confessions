...
export default function TopConfessions() {
    ...
    return (
        <>
            <Helmet>
                <title>Top Confessions - MMU Confessions</title>
                <meta name="description" content="Read the most popular and trending anonymous confessions from MMU students. See what's going viral on campus right now." />
            </Helmet>
