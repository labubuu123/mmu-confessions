...
export default function Matchmaker() {
    ...
    if (profile?.status === 'banned') {
        return (
            <div className="min-h-[60vh] bg-gray-50 dark:bg-gray-900 p-4 flex items-center justify-center">
                <div className="max-w-lg w-full p-8 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl text-center shadow-xl">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-red-100 dark:border-red-900/30 mb-6">
                        ...
                        <p className="text-sm text-gray-800 dark:text-gray-200 italic">"{profile.rejection_reason || 'Violation of community standards'}"</p>
                    </div>
                    <button onClick={handleResetIdentity} className="px-6 py-3 bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 text-red-700 dark:text-red-300 rounded-xl font-bold w-full">
                        Create New Identity
                    </button>
                </div>
            </div>
            ...
            <div className="fixed inset-0 z-[300] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                <div className="bg-white dark:bg-gray-800 w-full max-w-md rounded-2xl shadow-2xl border-l-8 border-yellow-500 overflow-hidden animate-in zoom-in-95 duration-200">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/50 p-4 flex justify-end">
                        <button onClick={handleAcknowledgeWarning} disabled={!agreedToGuidelines} className="px-6 py-2 bg-indigo-600 text-white font-bold rounded-lg hover:bg-indigo-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed">
                            Resume Matchmaker
                        </button>
                    </div>
                </div>
