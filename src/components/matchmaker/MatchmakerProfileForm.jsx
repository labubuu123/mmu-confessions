...
import { Check, Loader2, User, Heart, MapPin, AtSign, X, Sparkles, Trash2, AlertCircle, Info } from 'lucide-react';
...
const AvatarGenerator = ({ nickname, gender }) => {
    ...
    const bgColors = gender === 'male'
        ? ['#e0e7ff', '#dbeafe', '#ccfbf1', '#f3f4f6']
        : ['#fce7f3', '#ffe4e6', '#fef3c7', '#fae8ff'];
    ...
    return (
        <svg viewBox="0 0 100 100" className="w-full h-full rounded-full transition-all duration-500 group-hover:scale-105">
            ...
            <g fill="#1f2937">
                ...
                {eyesVariant === 1 && (
                    <>
                        <path d="M34 50 Q38 42 42 50" stroke="#1f2937" strokeWidth="3" fill="none" strokeLinecap="round" />
                        <path d="M58 50 Q62 42 66 50" stroke="#1f2937" strokeWidth="3" fill="none" strokeLinecap="round" />
                    </>
                )}
                {eyesVariant === 2 && (
                    <>
                        <circle cx="38" cy="48" r="4" />
                        <path d="M58 48 L66 48" stroke="#1f2937" strokeWidth="3" strokeLinecap="round" />
                    </>
                )}
            </g>
            ...
            <g stroke="#1f2937" strokeWidth="3" fill="none" strokeLinecap="round">
                ...
                {mouthVariant === 1 && (
                    <path d="M38 62 Q50 75 62 62" />
                )}
                {mouthVariant === 2 && (
                    <circle cx="50" cy="66" r="4" fill="#1f2937" stroke="none" />
                )}
            </g>

            {gender === 'male' ? (
                <path d="M25 40 Q50 15 75 40" fill="#1f2937" opacity="0.1" />
            ) : (
                <path d="M20 45 Q50 10 80 45" fill="#1f2937" opacity="0.1" />
            )}
        </svg>
    );
};
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto pb-20">
            <div className="text-center mb-10">
                ...
                <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto text-sm leading-relaxed">
                    Your avatar is generated automatically based on your unique nickname and gender.
            ...
            <div className="mb-8 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl flex items-start gap-3 text-blue-800 dark:text-blue-300 animate-in fade-in slide-in-from-top-2">
                ...
                <p className="text-sm font-medium leading-relaxed">
                    You must be serious when filling out every piece of information to show your honesty in finding a match on this website.
                    <br className="hidden md:block" />
                    Any unreliable information will be rejected by the admin. Please take this seriously.
                </p>
            </div>
                ...
                <div className="mb-8 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-2xl flex items-start gap-3 animate-in fade-in slide-in-from-top-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-yellow-700 dark:text-yellow-400 mt-1 leading-relaxed">
                            Your profile is currently <strong>pending</strong> admin review. It is not visible to other users yet.
                            <br />
                            You can still edit your details below and save again, or withdraw your application entirely.
                        </p>
                    </div>
                </div>
            )}
            ...
            {success && (
                <div className="mb-8 max-w-2xl mx-auto p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-2xl flex items-center gap-3 text-green-700 dark:text-green-300 animate-pulse">
                    ...
                    <span className="text-sm font-bold">Profile saved! Waiting for admin approval...</span>
                </div>
            )}
                        ...
                        <div className="md:col-span-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Melaka or Cyberjaya (Current Campus)"
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Describe your personality, hobbies, values, and what makes you unique..."
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="What kind of connection? Be honest about the friendship or relationship you want."
                                className={`${inputStyle} resize-none`}
                            ></textarea>
                        </div>
                                ...
                                {INTEREST_OPTIONS.map((interest) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-full text-sm font-bold transition-all transform active:scale-95 border flex items-center gap-2
                                                ${isSelected
                                                    ? 'bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-500/20'
                                                    : 'bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:border-indigo-300 dark:hover:border-indigo-700'
                                                }`}
                                        >
                ...
                <div className="relative overflow-hidden rounded-3xl border border-indigo-100 dark:border-indigo-900 shadow-sm">
                    ...
                    <div className="relative p-6 md:p-8">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300 mb-6 leading-relaxed max-w-2xl">
                            This information is <strong className="text-indigo-600 dark:text-indigo-400">encrypted and hidden</strong>.
                            It will <strong>only</strong> be revealed to someone if you both "Love" each other and match.
                        </p>

                        <div className="relative group">
                            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white font-semibold drop-shadow select-none pointer-events-none">
                                @
                            </span>
                ...
                <div className="flex flex-col-reverse md:flex-row justify-center gap-4 pt-4">
                    {profile?.status === 'pending' && (
                        <button
                            ...
                            disabled={loading}
                            className="w-full md:w-auto px-6 py-4 text-red-600 dark:text-red-400 font-bold rounded-2xl hover:bg-red-50 dark:hover:bg-red-900/20 border border-transparent hover:border-red-100 dark:hover:border-red-800 transition-all flex items-center justify-center gap-2"
                        >
                    ...
                    >
                        {loading ? (
                            ...
                            <>
                                <span>{profile ? 'Update Profile' : 'Submit Profile'}</span>
                            </>
                        )}
                    </button>
                </div>
